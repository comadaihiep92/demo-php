...
(1, 'webmaster@9GagCloneScript.com', 'Admin', 'f42c25af3d564dcdbad3c2f3134c5558');
...
ALTER TABLE `posts`  ADD `ttime` VARCHAR(20) NOT NULL,  ADD `htime` VARCHAR(20) NOT NULL;
ALTER TABLE `members` ADD `points` BIGINT( 50 ) NOT NULL ;
INSERT INTO `config` (`setting`, `value`) VALUES ('points_gag', '10');
INSERT INTO `config` (`setting`, `value`) VALUES ('points_view', '1');
INSERT INTO `config` (`setting`, `value`) VALUES ('enable_featured', '0');
ALTER TABLE `posts` ADD `feat` INT( 1 ) NOT NULL DEFAULT '0';
INSERT INTO `config` (`setting`, `value`) VALUES ('infinity_paging', '1');
ALTER TABLE `posts` ADD `rec` INT( 1 ) NOT NULL DEFAULT '0';
INSERT INTO `config` (`setting`, `value`) VALUES ('profile_max', '50');