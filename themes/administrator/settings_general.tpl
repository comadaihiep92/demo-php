                                        ...
                                        <fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="profile_max">Maximum Gags To Show On Profile Page </label></td>
                                                        <td class="value">
                                                            <input id="profile_max" name="profile_max" value="{$profile_max}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[IF INFINTY PAGING IS DISABLED, THIS NUMBER OF GAGS WILL SHOW UP ON THE PROFILE PAGE]</td>
                                                        <td><small></small></td>
                                                    </tr>
