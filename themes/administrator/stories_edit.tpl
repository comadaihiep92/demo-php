                                        ...
                                        <fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="rec">Recommended </label></td>
                                                        <td class="value">
                                                        	<select name="rec" id="rec">
                                                            <option value="1" {if $story.rec eq 1}selected{/if}>Yes</option>
                                                            <option value="0" {if $story.rec eq 0}selected{/if}>No</option>
                                                            </select>
                                                        </td>
                                                        <td class="scope-label">[RECOMMENDED GAGS RANDOMLY SHOW UP ON THE SIDE MENU]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="marknew">Mark As New </label></td>
                                                        <td class="value">
                                                        ...
                                                        <td class="scope-label">[THIS WILL MAKE THE GAG SHOW UP AT THE TOP OF THE HOT OR TRENDING SECTION]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
