...
{
	$arr = array("site_name", "contact_email", "site_email", "items_per_page", "quota", "mtrend", "approve_stories", "myes", "mno", "twitter", "FACEBOOK_APP_ID", "FACEBOOK_SECRET", "FACEBOOK_PROFILE", "FACEBOOK_ADMIN", "wm", "watermark", "infinity_paging", "enable_featured", "points_gag", "points_view", "profile_max");
